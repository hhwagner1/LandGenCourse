...
A more convenient way to extract the effects is with function 'ggeffect' of the package 'ggeffects'. This provides a mean for each block.
...
The plot shows the predicted d13c value for each block (accounting for population and family) and a 95% confidence interval for each predicted value.
