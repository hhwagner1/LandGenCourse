...
### a) Create a Bash R script

To execute our R script as a Bash script, we need to add a few lines. 
...
### b) Store your session info and package versions
