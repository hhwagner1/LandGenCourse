...
## ------------------------------------------------------------------------
ab <- anova(vegan::rda(WWP@P$d13c, WWP@E,  transfo="standardize"))
bc <- anova(vegan::rda(WWP@P$d13c, WWP@XY, transfo="standardize"))
abc <- anova(vegan::rda(WWP@P$d13c, data.frame(WWP@E, WWP@XY), transfo="standardize"))
a <- anova(vegan::rda(WWP@P$d13c, WWP@E, WWP@XY, transfo="standardize"))
b <- anova(vegan::rda(WWP@P$d13c, WWP@XY, WWP@E, transfo="standardize"))
