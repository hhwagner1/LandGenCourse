...
First we create in our current R project folder a subfolder named "simout".

```{r, eval=F}
if(!dir.exists(paste0(here::here(),"/output"))) 
    dir.create(paste0(here::here(),"/output"), recursive=TRUE)
if(!dir.exists(paste0(here::here(),"/output/simout"))) 
    dir.create(paste0(here::here(),"/output/simout"), recursive=TRUE)
```

**NOTE HW: I have replace 'rdata' by 'RData'.
...
- For each line 'i' in 'para.space':
    ...
    - Save the object 'sim' as an 'RData' file with a unique file name in the folder 'simout' that we created above.
