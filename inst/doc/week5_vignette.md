...
\`\`\`{r include=FALSE} corm.GD.pop &lt;- lapply\(GD.pop, function\(x\) EcoGenetics::eco.cormantel\(M = x, XY = ecoslot.XY\(Frogs.ecopop\)\[,1:2\], nsim = 199, latlon=FALSE, alternative="less"\)\)
