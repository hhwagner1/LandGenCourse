...
if (info$version < "1.4") {
  cat("Please update RStudio. Your version is: ", info$version)
}
...
#####################################
#if(!"popgraph" %in% pkg) {
#  install.packages("http://cran.r-project.org/src/contrib/Archive/popgraph/popgraph_1.4.tar.gz",
#                   repos=NULL, type="source") }
#if(!"gstudio" %in% pkg) {
#  install.packages("http://cran.r-project.org/src/contrib/Archivess/gstudio/gstudio_1.3.tar.gz",
#                   repos=NULL, type="source") }
if(!"base64enc" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/base64enc_0.1-3.tar.gz",
                   repos=NULL, type="source")}
if(!"cowplot" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/cowplot_1.0.0.tar.gz",
                   repos=NULL, type="source")}
if(!"effsize" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/effsize_0.7.6.tar.gz",
                   repos=NULL, type="source")}
if(!"hierfstat" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/hierfstat_0.04-22.tar.gz",
                   repos=NULL, type="source")}
if(!"mapplots" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/mapplots_1.5.1.tar.gz",
                   repos=NULL, type="source")}
if(!"microbenchmark" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/microbenchmark_1.4-7.tar.gz",
                   repos=NULL, type="source")}
if(!"predictmeans" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/predictmeans_1.0.1.tar.gz",
                   repos=NULL, type="source")}
if(!"profvis" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/profvis_0.3.6.tar.gz",
                   repos=NULL, type="source")}
if(!"pwr" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/pwr_1.2-2.tar.gz",
                   repos=NULL, type="source")}
if(!"Sunder" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/Sunder_0.0.4.tar.gz",
                   repos=NULL, type="source")}
if(!"usdm" %in% pkg) {
  install.packages("http://cran.r-project.org/src/contrib/usdm_1.1-18.tar.gz",
                   repos=NULL, type="source")}
...
#if( Sys.info()['sysname'] == "Windows") {
#  if(!"poppr" %in% pkg) {
#    install.packages("http://cran.r-project.org/bin/windows/contrib/4.0/poppr_2.8.3.zip",
#                     repos=NULL, type="win.binary")}
#} else {
#  if(!"poppr" %in% pkg) {
#    install.packages("http://cran.r-project.org/macosx/el-capitan/contrib/3.6/poppr_2.8.3.tgz",
    ...
    if(!x[i] %in% pkg$Package)
	{
      ...
      if(install) {
        cat("    Installing", x[i], "to", file.path(R.home(), "library"), "\n\n")
	      try( install.packages(x[i], repos = "http://cran.us.r-project.org") )
...
cran.pkg <- c("ade4", "adegenet", "BiocManager", "car", "compiler", "data.table",
...
if(!"secr" %in% pkg) { install.packages("secr", dependencies="Imports", type="binary")}
