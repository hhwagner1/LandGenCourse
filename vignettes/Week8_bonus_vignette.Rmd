...
We use the function 'purl' from the 'knitr' package to extract the R code from a Notebook (here, we'll use the Week 0 vignette on R graphics as this runs quickly):
