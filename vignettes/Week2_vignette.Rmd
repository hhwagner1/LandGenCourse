...
Note: Package 'tmaptools' has not been automatically installed with 'LandGenCourse' to avoid incompatibilities. To use the function, you may first need to install 'tmaptools' by running the line with 'install.packages("tmaptools")' without '#'.
